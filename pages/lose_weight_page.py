...
class LoseWeightPage:
    ...
    def select_lose_weight(self, lose_weight_value: str):
        ...
        print(f"⚖️ Selecting lose weight option: {lose_weight_value}")
